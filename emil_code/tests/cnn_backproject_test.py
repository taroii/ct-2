...
time0 = time.time()
data.backproject_to(image_cpu,alg='adj_nearest')
# CPU done in  72.36 seconds
time1 = time.time()
print "CPU  nn bp done in", time1 - time0," seconds."
...
print "starting GPU art..."
time0 = time.time()
image_gpu.cnn_backproject(data,nub,nvb,ubs,vbs)
#image_gpu.clin_art_step(data,64,1,4,2)
#image_gpu.clin_art_step(data,1,64,128,1)
#image_gpu.cnn_art_step(data,1,64,128,1) # This way is a factor of 10 slower
time1 = time.time()
...
time0 = time.time()
image_gpu.cnn_backproject(data_fl,nvb,nub,vbs,ubs)
#image_gpu.clin_art_step(data,64,1,4,2)
#image_gpu.clin_art_step(data,1,64,128,1)
#image_gpu.cnn_art_step(data,1,64,128,1) # This way is a factor of 10 slower
time1 = time.time()
