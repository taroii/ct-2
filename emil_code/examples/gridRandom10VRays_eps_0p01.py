# linogram data example w/ random rays
...
# on the ball and random sampling on a flat-panel detector
...
for iv in range(nr0):
   ...
   u = u00+ ulen0*random.random()
   v = v00+ vlen0*random.random()
   if mod(raycount,1000) ==1:
      print vtheta/pi,vphi/pi,u,v
